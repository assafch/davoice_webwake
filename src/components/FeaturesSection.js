...
const FeaturesSection = () => {
  return (
    <div className="bg-gray-900 flex items-center justify-center p-4 skew-y-1">
      <div className="rounded-lg shadow-lg p-10 max-w-4xl mx-auto transform">
        <div className="border-l-8 border-blue-500 pl-8">
          <h2 className="text-3xl font-semibold dark:text-gray-400 mb-4">Why DaVoice?</h2>
          ...
          <h3 className="text-xl font-semibold dark:text-gray-400 mb-4">Features</h3>
          <ul className="dark:text-white mb-4 list-disc pl-5">
