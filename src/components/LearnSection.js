  ...
  return (
    <section className="py-16 px-6 bg-white dark:bg-gray-800">
      <div className="container mx-auto px-6 grid">
        <h2 className="text-3xl font-semibold mb-6 text-gray-900 dark:text-white">Learning about  <strong>"Wake Word"</strong> and <strong>"Speech-to-Intent"</strong></h2>
        <div className="space-y-4">
          <details open className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg shadow">
          ...
          <details open className="bg-gray-700 p-4 rounded-lg shadow">
