                ...
                <div className="container mx-auto px-4 mt-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="grid place-items-center lg:place-items-start">
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 justify-self-center">
                            {/* Android Icon */}
                            <FaAndroid className="w-16 h-16 text-current" />

                            {/* Apple Icon */}
                            <FaApple className="w-16 h-16 text-current" />

                            {/* React Icon */}
                            <FaReact className="w-16 h-16 text-current" />

                            {/* Flutter Icon */}
                            <SiFlutter className="w-16 h-16 text-current" />

                            {/* Java Icon */}
                            <FaJava className="w-16 h-16 text-current" />

                            {/* Python Icon */}
                            <FaPython className="w-16 h-16 text-current" />
                        </div>
                    </div>
                    ...
                    <div className="grid gap-6">
                        <h3 className="text-2xl font-bold text-white">
                            DaVoice.AI offers the most versatile wake word detection solution on the
                            market:
                        </h3>
